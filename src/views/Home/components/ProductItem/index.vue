<template>
  <div class="x-product-item">
    ...
    <div class="x-shop-name flex justify-left items-center">
      ...
      <span class="x-name">{{ data.poiAddress }}</span>
    </div>
    <!-- E 门店名称区域  -->
    ...
    >
      ...
      <div class="x-product-info flex flex-col">
        ...
        <div class="flex items-center justify-between">
          ...
          <span class="x-sale-count">已售 {{ data.cardData.sold_count }}</span>
        </div>
        <!-- E 商品标签和销售 -->
        ...
        <div class="x-price-box flex justify-between item-center">
          <label class="x-real-price">
            <span class="x-old-price">{{ data.cardData.origin_amount }}</span>
            <span class="x-price">{{ data.cardData.actual_amount }}</span>
          </label>
          <label class="x-discount-price">
            <span>返</span>
            <span class="x-price">￥{{ data.commissionAmount }}</span>
          </label>
        </div>
         <!-- E 商品价格和优惠区域 -->
      </div>
